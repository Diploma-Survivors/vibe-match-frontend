...
export default function FramerMotionPlayground() {
    ...
    const toggleElement = (element: any) => {
        setActiveElements((prev) => ({
            ...prev,
            [element]: !prev[element as keyof typeof activeElements],
        }));
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-white to-slate-100 text-slate-900 p-6">
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                >
                    ...
                    >
                        {'Motion Playground Pro'.split('').map((char, idx) => (
                            <motion.span
                                key={idx}
