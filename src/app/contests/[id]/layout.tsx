...
export default function ContestLayout({ children }: { children: React.ReactNode }) {
    ...
    if (!contest) {
        return <div className="min-h-screen flex items-center justify-center text-slate-600 dark:text-slate-300">Contest not found</div>;
    }

    return (
        <div className="min-h-screen bg-white dark:bg-slate-900">
            <ContestNavbar contest={contest} activeTab={activeTab} onTabChange={handleTabChange} />
