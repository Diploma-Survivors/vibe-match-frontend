            ...
            <div className="mb-6">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <label htmlFor="showNames" className="text-sm text-slate-600 dark:text-slate-400">
            ...
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-lg border border-white/20 dark:border-slate-700/50 shadow-xl overflow-hidden">
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="bg-slate-800 dark:bg-slate-900 text-white">
                                ...
                                <th className="px-4 py-3 text-center font-bold w-20">1<br /><span className="text-xs">100</span></th>
                                <th className="px-4 py-3 text-center font-bold w-20">2<br /><span className="text-xs">100</span></th>
                                <th className="px-4 py-3 text-center font-bold w-20">3<br /><span className="text-xs">100</span></th>
                                <th className="px-4 py-3 text-center font-bold w-20">4<br /><span className="text-xs">100</span></th>
                                <th className="px-4 py-3 text-center font-bold w-20">5<br /><span className="text-xs">100</span></th>
                        ...
                        <tbody>
                            <tr className="border-b border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/30 bg-blue-50 dark:bg-blue-900/20">
                                ...
                                <td className="px-4 py-3 text-center">
                                    ...
                                    <div className="text-xs text-slate-500">{userHistory.time}</div>
                                </td>
                ...
                <div className="bg-slate-100 dark:bg-slate-700 border-t border-slate-200 dark:border-slate-600">
                    <table className="w-full">
                        <tbody>
                            <tr>
                                <td className="px-4 py-2 text-center font-bold" colSpan={3}>Total AC</td>
                                {userHistory.problems.map((problem, index) => (
                                    <td key={index} className="px-2 py-2 text-center font-bold w-20">
                                        {problem.points > 0 ? 1 : 0}
                                    </td>
                                ))}
                                <td className="px-4 py-2 text-center font-bold">
                                    {userHistory.problems.reduce((acc, p) => acc + (p.points > 0 ? 1 : 0), 0)}
                                </td>
                            </tr>
                        </tbody>
                    </table>
