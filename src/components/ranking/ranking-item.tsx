        ...
        <div className="flex-shrink-0">
          ...
          >
            {user.avatar ? (
              ...
              <div
                className={`w-full h-full bg-gradient-to-br ${getAvatarGradient(user.rank, user.rating)} flex items-center justify-center text-white font-bold text-lg shadow-inner`}
              >
