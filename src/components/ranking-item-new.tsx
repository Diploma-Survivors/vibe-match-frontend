    ...
    return (
      ...
      `}>
          ...
          `}>
            ...
            ${isTopThree ? 'w-14 h-14 ring-3 ring-slate-200/50 dark:ring-slate-600/50' : 'w-12 h-12'}
          `}>
                        {user.avatar ? (
                            <img
                                src={user.avatar}
                                ...
                                onError={(e) => {
                                    ...
                                    fallback.className = 'w-full h-full bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-600 dark:to-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300 font-bold text-lg';
                                    fallback.textContent = user.username.charAt(0).toUpperCase();
                                    target.parentElement?.appendChild(fallback);
                                }}
                            />
                        ) : (
                            <div className="w-full h-full bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-600 dark:to-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300 font-bold text-lg">
